package org.flixel.system
{
	 ...
	 */
	public class AxDebugger extends Sprite
	{
		/**
		 ...
		 */
		public function AxDebugger(Width:Number,Height:Number)
		{
			super();
			visible = false;
			hasMouse = false;
			...
			var str:String = Ax.getLibraryName();
			if(Ax.debug)
				str += " [debug]";
			else
				str += " [release]";
			...
			setLayout(Ax.DEBUGGER_STANDARD);
		...
		/**
		 * Rearrange the debugger windows using one of the constants specified in Ax.
		 * 
		 * @param	Layout		The layout style for the debugger windows, e.g. <code>Ax.DEBUGGER_MICRO</code>.
		 */
		 ...
		 * The default layout is <code>Ax.DEBUGGER_STANDARD</code>.
		 */
		public function resetLayout():void
		{
			switch(_layout)
			{
				case Ax.DEBUGGER_MICRO:
