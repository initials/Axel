package org.flixel.system.debug
{
	...
	import org.flixel.system.AxWindow;
	 ...
	 * @author Adam Atomic
	 */
	public class Perf extends AxWindow
	{
		...
		/**
		 * Creates flashPlayerFramerate new window object.  This Flash-based class is mainly (only?) used by <code>AxDebugger</code>.
		 * 
		...
		public function update():void
		{
			...
			if(_updateTimer > updateEvery)
			{
				...
				output += uint(1/(flashPlayerFramerate/1000)) + "/" + Ax.flashFramerate + "fps\n";
