package org.flixel.system
{
	...
	import org.flixel.AxTilemap;
	
	/**
	 * A simple helper object for <code>AxTilemap</code> that helps expand collision opportunities and control.
	 * You can use <code>AxTilemap.setTileProperties()</code> to alter the collision properties and
	...
	public class AxTile extends AxEntity
	{
		 ...
		 * This function should take the form <code>myFunction(Tile:AxTile,Object:AxEntity):void</code>.
		 * Defaults to null, set through <code>AxTilemap.setTileProperties()</code>.
		 */
		...
		/**
		 * Instantiate this new tile object.  This is usually called from <code>AxTilemap.loadMap()</code>.
		 * 
		 ...
		 */
		public function AxTile(Tilemap:AxTilemap, Index:uint, Width:Number, Height:Number, Visible:Boolean, AllowCollisions:uint)
		{
