package org.flixel.system
{
	 ...
	 */
	public class AxPreloader extends MovieClip
	{
		...
		public function AxPreloader()
		{
            ...
            {
                var re:RegExp = /\[.*:[0-9]+\]/;
                Ax.debug = re.test(E.getStackTrace());
            }
			
			var tmp:Bitmap;
			if(!Ax.debug && (myURL != null) && (root.loaderInfo.url.indexOf(myURL) < 0))
			{
		...
		protected function update(Percent:Number):void
		{
			...
			_text.text = "Ax v"+Ax.LIBRARY_MAJOR_VERSION+"."+Ax.LIBRARY_MINOR_VERSION+" "+Math.floor(Percent*100)+"%";
