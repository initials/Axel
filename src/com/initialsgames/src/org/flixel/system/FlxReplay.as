package org.flixel.system
{
	...
	public class AxReplay
	{
		...
		{
			var keysRecord:Array = Ax.keys.record();
			var mouseRecord:MouseRecord = Ax.mouse.record();
		...
		public function playNextFrame():void
		{
			...
			if(fr.keys != null)
				Ax.keys.playback(fr.keys);
			if(fr.mouse != null)
				Ax.mouse.playback(fr.mouse);
		}
