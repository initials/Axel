package org.flixel.system
{
	...
	public class AxTilemapBuffer
	{
		 ...
		 */
		public function AxTilemapBuffer(TileWidth:Number,TileHeight:Number,WidthInTiles:uint,HeightInTiles:uint,Camera:AxCamera=null)
		{
			if(Camera == null)
				Camera = Ax.camera;

			columns = AxU.ceil(Camera.width/TileWidth)+1;
			if(columns > WidthInTiles)
				columns = WidthInTiles;
			rows = AxU.ceil(Camera.height/TileHeight)+1;
		 ...
		 */
		public function draw(Camera:AxCamera,FlashPoint:Point):void
		{
