package org.flixel.system.input
{
	 ...
	 * @author Adam Atomic
	 */
	public class Mouse extends AxPoint
	{
		 ...
		 * This container is a child of AxGame and sits at the right "height".
		 */
		...
		protected var _globalScreenPosition:AxPoint;
		...
		public function Mouse(CursorContainer:Sprite)
		{
			...
			_cursor = null;
			_point = new AxPoint();
			_globalScreenPosition = new AxPoint();
		}
		 ...
		 */
		public function getWorldPosition(Camera:AxCamera=null,Point:AxPoint=null):AxPoint
		{
			if(Camera == null)
				Camera = Ax.camera;
			if(Point == null)
		 ...
		 */
		public function getScreenPosition(Camera:AxCamera=null,Point:AxPoint=null):AxPoint
		{
			if(Camera == null)
				Camera = Ax.camera;
			if(Point == null)
		...
		/**
		 * Event handler so AxGame can update the mouse.
		 * 
