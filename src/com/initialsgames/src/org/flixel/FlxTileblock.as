package org.flixel
{
	 ...
	 * @author Adam Atomic
	 */
	public class AxTileblock extends AxSprite
	{		
		/**
		 * Creates a new <code>AxBlock</code> object with the specified position and size.
		 * 
		 ...
		 */
		public function AxTileblock(X:int,Y:int,Width:uint,Height:uint)
		{
			super(X,Y);
		 ...
		 */
		public function loadTiles(TileGraphic:Class,TileWidth:uint=0,TileHeight:uint=0,Empties:uint=0, Autotile:Boolean=true):AxTileblock
		{
			if(TileGraphic == null)
				return this;
			
			//First create a tile brush
			var sprite:AxSprite = new AxSprite().loadGraphic(TileGraphic,true,false,TileWidth,TileHeight);
