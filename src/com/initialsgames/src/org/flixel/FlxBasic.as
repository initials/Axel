...
{	
	 ...
	 * Both <code>AxEntity</code> and <code>AxGroup</code> extend this class,
	 * as do the plugins.  Has no size, position or graphical data.
	 * 
	 * @author	Adam Atomic
	 */
	public class AxBasic
	{
		...
		public var ID:int;
		/**
		 * Controls whether <code>update()</code> and <code>draw()</code> are automatically called by AxState/AxGroup.
		 */
		public var exists:Boolean;
		/**
		 * Controls whether <code>update()</code> is automatically called by AxState/AxGroup.
		 */
		public var active:Boolean;
		/**
		 * Controls whether <code>draw()</code> is automatically called by AxState/AxGroup.
		 */
		 ...
		 * point at the main camera list out in <code>AxG</code> unless you already set it.
		 ...
		 * In practice, this function is most often called by <code>AxEntity.reset()</code>.
		 */
		...
		{
			return AxU.getClassName(this,true);
		}
	}
}
