...
package org.flixel.plugin.photonstorm.FX 
{
	...
	/**
	 * Creates a static / glitch / monitor-corruption style effect on an AxSprite
	 * 
	 * TODO:
	 * 
	...
	public class RevealFX extends BaseFX
	{
		...
		public function createFromAxSprite(source:AxSprite, maxGlitch:uint, maxSkip:uint, autoUpdate:Boolean = false, backgroundColor:uint = 0x0):AxSprite
		{
			sprite = new AxSprite(source.x, source.y).makeGraphic(source.width + maxGlitch, source.height, backgroundColor);
