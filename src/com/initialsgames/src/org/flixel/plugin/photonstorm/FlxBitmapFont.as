...
package org.flixel.plugin.photonstorm 
{
	...
	public class AxBitmapFont extends AxSprite
	{
		/**
		 * Alignment of the text when multiLine = true or a fixedWidth is set. Set to AxBitmapFont.ALIGN_LEFT (default), AxBitmapFont.ALIGN_RIGHT or AxBitmapFont.ALIGN_CENTER.
		 */
		 ...
		 */
        public function AxBitmapFont(font:Class, characterWidth:uint, characterHeight:uint, chars:String, charsPerRow:uint, xSpacing:uint = 0, ySpacing:uint = 0, xOffset:uint = 0, yOffset:uint = 0):void
        {
		...
		/**
		 * If you need this AxSprite to have a fixed width and custom alignment you can set the width here.<br>
		 * If text is wider than the width specified it will be cropped off.
		 * 
		 * @param	width			Width in pixels of this AxBitmapFont. Set to zero to disable and re-enable automatic resizing.
		 * @param	lineAlignment	Align the text within this width. Set to AxBitmapFont.ALIGN_LEFT (default), AxBitmapFont.ALIGN_RIGHT or AxBitmapFont.ALIGN_CENTER.
		 */
		 ...
		 * @param	lineAlignment		Align each line of multi-line text. Set to AxBitmapFont.ALIGN_LEFT (default), AxBitmapFont.ALIGN_RIGHT or AxBitmapFont.ALIGN_CENTER.
		...
		/**
		 * Returns a single character from the font set as an AxSprite.
		 * 
		 * @param	char	The character you wish to have returned.
		 * 
		 * @return	An <code>AxSprite</code> containing a single character from the font set.
		 */
		public function getCharacter(char:String):AxSprite
		{
			var output:AxSprite = new AxSprite();
