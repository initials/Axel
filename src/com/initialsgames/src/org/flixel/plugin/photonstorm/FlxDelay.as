...
package org.flixel.plugin.photonstorm 
{
	...
	public class AxDelay extends Sprite
	{
		/**
		 ...
		 */
		public function AxDelay(runFor:int)
		{
			duration = runFor;
		}
		...
		private function update(event:Event):void
		{
			...
			if (pausedTimerRunning == true && Ax.paused == false)
			{
				pausedTimerRunning = false;
			...
			else if (Ax.paused == true && pausedTimerRunning == false)
			{
