...
package org.flixel.plugin.photonstorm.FX 
{
	...
	{
		/**
		 * Set to false to stop this effect being updated by the AxSpecialFX Plugin. Set to true to enable.
		 */
		public var active:Boolean;
		
		/**
		 * The AxSprite into which the effect is drawn. Add this to your AxState / AxGroup to display the effect.
		 */
		...
		internal var sourceRef:AxSprite;
