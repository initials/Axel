 ...
 * 
 * v1.3 Added full AxFlectrum support
...
package org.flixel.plugin.photonstorm 
{
	...
	/**
	 * AxFlod adds support for the Flod AS3 Replay library by Christian Corti.<br />
	 ...
	 * <br />
	 * Or you can patch AxG manually by doing the following:<br /><br />
	 * 
	 * 1) Add <code>import com.photonstorm.flixel.AxFlod;</code> at the top of Ax.as:<br />
	 * 2) Find the function <code>static public function set mute(Mute:Boolean):void</code> and add this line at the end of it: <code>AxFlod.mute = Mute;</code><br />
	 * 3) Find the function <code>static public function set volume(Volume:Number):void</code> and add this line at the end of it: <code>AxFlod.volume = Volume;</code><br />
	 * 4) Find the function <code>static protected function pauseSounds():void</code> and add this line at the end of it: <code>AxFlod.pause();</code><br />
	 * 5) Find the function <code>static protected function playSounds():void</code> and add this line at the end of it: <code>AxFlod.resume();</code><br /><br />
	 * 
	 * Flixel will now be patched so that any music playing via AxFlod responds to the global flixel mute, volume and pause controls
	 */
	...
	public class AxFlod
	{
		 ...
		 * 
		 * @return	The AxFlectrum instance for further modification. Also available via AxFlod.flectrum
		 */
		public static function createFlectrum(x:int, y:int, meter:Class = null, showBackground:Boolean = false, backgroundBeat:Boolean = false, columns:int = 15, columnSize:int = 10, columnSpacing:int = 0, rows:int = 32, rowSize:int = 3, rowSpacing:int = 0):AxFlectrum
		{
			flectrum = new AxFlectrum();
		...
		/**
		 * Called by AxG when the volume is adjusted in-game
		 * 
		 * @param	Volume
		 */
		...
		/**
		 * Sets the playback volume directly (usually controlled by Ax.volume)
		 */
