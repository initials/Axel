...
{
	import org.axgl.*;
	import org.flixel.plugin.photonstorm.AxExtendedSprite;
	
	public class MouseSpring 
	{
		public var sprite:AxExtendedSprite;
		 ...
		 * 
		 * @param	sprite				The AxExtendedSprite to which this spring is attached
		 ...
		 */
		public function MouseSpring(sprite:AxExtendedSprite, retainVelocity:Boolean = false, tension:Number = 0.1, friction:Number = 0.95, gravity:Number = 0)
		{
			this.sprite = sprite;
		...
		{
			dx = Ax.mouse.x - sprite.springX;
			dy = Ax.mouse.y - sprite.springY;
