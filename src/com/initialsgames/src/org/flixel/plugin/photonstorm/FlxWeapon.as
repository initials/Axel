...
package org.flixel.plugin.photonstorm 
{
	...
	public class AxWeapon 
	{
		...
		/**
		 * The AxGroup into which all the bullets for this weapon are drawn. This should be added to your display and collision checked against it.
		 */
		public var group:AxGroup;
		...
		private var positionOffset:AxPoint;
		
		private var velocity:AxPoint;
		...
		public var onKillSound:AxSound;
		public var onFireSound:AxSound;
		...
		private var magazineSwapSound:AxSound;
		...
		/**
		 * Creates the AxWeapon class which will fire your bullets.<br>
		 ...
		 */
		public function AxWeapon(name:String, parentRef:* = null, xVariable:String = "x", yVariable:String = "y")
		{
			this.name = name;
			
			bounds = new AxRect(0, 0, Ax.width, Ax.height);
			
			positionOffset = new AxPoint;
		 ...
		 * @param	target
		 */
		private function runFire(method:uint, x:int = 0, y:int = 0, target:AxSprite = null, angle:int = 0):void
		{
		 ...
		 * 
		 * @param	target	The AxSprite you wish to fire the bullet at
		 */
		public function fireAtTarget(target:AxSprite):void
		{
		...
		/**
		 * Sets the firing rate of the Weapon. By default there is no rate, as it can be controlled by AxControl.setFireButton.<br>
		 ...
		 * 
		 * @param	bounds	An AxRect area. Inside this area the bullet should be considered alive, once outside it will be killed.
		 */
		public function setBulletBounds(bounds:AxRect):void
		{
			this.bounds = bounds;
		}
		...
		{
			velocity = AxVelocity.velocityFromAngle(angle, speed);
		}
