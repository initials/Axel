...
package org.flixel.plugin.photonstorm.FX 
{
	...
	public class BlurFX extends BaseFX
	{
		 ...
		 * Add the resulting AxSprite to your display to see the effect.
		 * 
		 * @param	width			The width (in pixels) of the resulting AxSprite containing the Blur effect
		 * @param	height			The height (in pixels) of the resulting AxSprite containing the Blur effect
		 ...
		 * 
		 * @return	An AxSprite containing the updating blur effect
		 */
		public function create(width:int, height:int, blurX:Number, blurY:Number, blurQuality:int = 1):AxSprite
		{
			sprite = new AxSprite(0, 0).makeGraphic(width, height, 0x0, true);
		...
		/**
		 * Adds an AxSprite to the BlurFX. Every loop this sprite will be drawn to the FX and then blurred if the AxSprite is both onScreen() and visible.
		 * 
		 * @param	source		The AxSprite to add to the blur effect
		 * @param	autoRemove	If true and the AxSprite.exists value ever equals false then BlurFX will automatically remove it
		 */
		public function addSprite(source:AxSprite, autoRemove:Boolean = true):void
		{
		...
		/**
		 * Removes the AxSprite from the effect
		 * 
		 * @param	source		The AxSprite to remove from the blur effect
		 */
		public function removeSprite(source:AxSprite):void
		{
