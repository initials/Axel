...
package org.flixel.plugin.photonstorm.FX 
{
	...
	/**
	 * Creates a flood fill effect AxSprite, useful for bringing in images in cool ways
	 */
	public class FloodFillFX extends BaseFX
	{
		 ...
		 * 
		 * @return	An AxSprite with the effect ready to run in it
		 */
		public function create(source:AxSprite, x:int, y:int, width:uint, height:uint, direction:uint = 0, pixels:uint = 1, split:Boolean = false, backgroundColor:uint = 0x0):AxSprite
		{
