 ...
 * v1.0 First release of the new AxSpecialFX system
 * 
...
package org.flixel.plugin.photonstorm 
{
	...
	/**
	 * AxSpecialFX is a single point of access to all of the FX Plugins available in the Flixel Power Tools
	 */
	public class AxSpecialFX extends AxBasic
	{
		private static var members:Dictionary = new Dictionary(true);
		
		public function AxSpecialFX() 
		{
		}
		...
		/**
		 * Destroys all FX Plugins currently added and then destroys this instance of the AxSpecialFX Plugin
		 */
