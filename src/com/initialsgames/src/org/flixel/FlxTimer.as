package org.flixel
{
	...
	public class AxTimer
	{
		 ...
		 * Callback should be formed "onTimer(Timer:AxTimer);"
		 */
		 ...
		 * @param	Callback	Optional, triggered whenever the time runs out, once for each loop.  Callback should be formed "onTimer(Timer:AxTimer);"
		 * 
		 * @return	A reference to itself (handy for chaining or whatever).
		 */
		public function start(Time:Number=1,Loops:uint=1,Callback:Function=null):AxTimer
		{
		...
		{
			return Ax.getPlugin(TimerManager) as TimerManager;
		}
	}
}