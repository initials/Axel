package org.flixel
{
	...
	/**
	 * Extends <code>AxSprite</code> to support rendering text.
	 ...
	 * @author	Adam Atomic
	 */
	public class AxText extends AxSprite
	{
		/**
		 ...
		 * This is NOT the same thing as <code>AxSprite.dirty</code>.
		 */
		...
		/**
		 * Creates a new <code>AxText</code> object at the specified position.
		 * 
		 ...
		 */
		public function AxText(X:Number, Y:Number, Width:uint, Text:String=null, EmbeddedFont:Boolean=true)
		{
			super(X,Y);
		 ...
		 * 
		 * @return	This AxText instance (nice for chaining stuff together, if you're into that).
		 */
		public function setFormat(Font:String=null,Size:Number=8,Color:uint=0xffffff,Alignment:String=null,ShadowColor:uint=0):AxText
		{
			if(Font == null)
				Font = "";
