package org.flixel
{
	 ...
	 * of <code>AxSprite</code> to have slightly more specialized behavior
	 * common to many game scenarios.  You can override and extend this class
	 * just like you would <code>AxSprite</code>. While <code>AxEmitter</code>
	 * used to work with just any old sprite, it now requires a
	 * <code>AxParticle</code> based class.
	 * 
	 * @author Adam Atomic
	 */
	public class AxParticle extends AxSprite
	{
		/**
		...
		/**
		 * Instantiate a new particle.  Like <code>AxSprite</code>, all meaningful creation
		 * happens during <code>loadGraphic()</code> or <code>makeGraphic()</code> or whatever.
		 */
		public function AxParticle()
		{
			super();
			lifespan = 0;
			friction = 500;
		...
		/**
		 * Triggered whenever this object is launched by a <code>AxEmitter</code>.
