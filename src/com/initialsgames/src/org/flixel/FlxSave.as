package org.flixel
{
	 ...
	 * @author	Adam Atomic
	 */
	public class AxSave extends Object
	{
		...
		public function bind(Name:String):Boolean
		{
			...
			{
				Ax.log("ERROR: There was a problem binding to\nthe shared object data from AxSave.");
				destroy();
				return false;
			}
		...
		protected function onDone(Result:uint):Boolean
		{
			...
			{
				case PENDING:
					Ax.log("FLIXEL: AxSave is requesting extra storage space.");
					break;
				case ERROR:
					Ax.log("ERROR: There was a problem flushing\nthe shared object data from AxSave.");
					break;
				default:
					break;
			}
		...
		protected function checkBinding():Boolean
		{
			...
			{
				Ax.log("FLIXEL: You must call AxSave.bind()\nbefore you can read or write data.");
				return false;
			}
			return true;
		}
